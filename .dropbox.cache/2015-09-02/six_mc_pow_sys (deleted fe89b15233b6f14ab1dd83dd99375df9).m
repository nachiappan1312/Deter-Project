...
tic;
%Inputs
strat1 = 'Sep2_Strat1_Run1'; strat2 = 'Sep2_Strat2_Run1';
max_duration = 1; % duration of attack
duration = 5;     % Initial Duration   
no_of_runs = 5; % 10 different time instants
res_file = 'Results_Sheet_Sep2.csv';
%Result Folders
...
for duration = 1:max_duration
    for j = 1:1:no_of_runs
        ...
        rand_time_inst = ceil((Time_of_attack(j)/12)*s(2));
        for k = 1:s(2)
